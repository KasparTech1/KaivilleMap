...
1. Provide relevant sources and citations throughout your response where applicable
2. At the end of your response, include a "Sources and References" section listing all sources used
3. Include the following disclaimer at the very end:

---
DISCLAIMER: This research report was generated by ${model.toUpperCase()} AI and should be verified for accuracy. While AI systems strive to provide reliable information, they may occasionally produce errors or outdated information. Please cross-reference critical data points and consult with domain experts for business-critical decisions.
    ...
    if (model === 'claude') {
      ...
      try {
        const response = await anthropic.messages.create({
          ...
          max_tokens: 4096,
          temperature: 0.7,
          system: 'You are a professional research analyst for Kaspar Companies. Provide detailed, well-structured research with proper citations. Format your response with clear sections, bullet points where appropriate, and ensure all claims are backed by sources.',
          messages: [{
            role: 'user',
      ...
      try {
        const response = await openai.chat.completions.create({
          ...
          messages: [
            {
              role: 'system',
              content: 'You are a professional research analyst for Kaspar Companies. Provide detailed, well-structured research with proper citations. Format your response with clear sections, bullet points where appropriate, and ensure all claims are backed by sources.'
            },
            {
              role: 'user',
              content: enhancedPrompt
