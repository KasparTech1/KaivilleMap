    ...
    return (
      <Link to={`/building/${building.id}`} className="block" style={style}>
        <div className={`relative hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 ease-in-out cursor-pointer group ${
          building.id === 'heritage_center' ? '-mt-[20%] md:-mt-[18%] md:ml-[10%]' : 
          building.id === 'learning_lodge' ? 'scale-x-[0.75] scale-y-100 -mt-[50%] -ml-[25%] translate-y-[-45px] md:scale-x-[0.75] md:scale-y-100 md:mt-[10%] md:-ml-[15%] md:translate-y-0' : 
