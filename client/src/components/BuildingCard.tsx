    ...
    return (
      <Link to={`/building/${building.id}`} className="block" style={style}>
        <div className={`relative ${
          ...
          building.id === 'learning_lodge' ? 'scale-[0.748] -mt-[50%] -ml-[25%] translate-y-[-55px] md:scale-[0.748] md:mt-[10%] md:-ml-[15%] md:translate-y-[-30px]' : 
          building.id === 'community-center' ? 'mt-[60%] translate-y-[-30px] md:mt-0 md:translate-y-[-20px]' : 
          building.id === 'celebration_station' ? 'scale-[1.5] hover:scale-[1.575] -mt-[25%] ml-[50%] -translate-x-[25px] translate-y-[-50px] md:scale-[1.5] md:hover:scale-[1.575] md:-mt-[10%] md:ml-[40%] md:-translate-x-[220px] md:translate-y-[-30px]' : 
