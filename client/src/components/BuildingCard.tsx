    ...
    return (
      <Link to={`/building/${building.id}`} className="block" style={style}>
        <div className={`relative hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 ease-in-out cursor-pointer group ${
          ...
          building.id === 'celebration_station' ? '-mt-[25%] ml-[50%] md:scale-[1.1] md:-mt-[10%] md:ml-[40%] md:-translate-x-[220px]' : 
          building.id === 'kasp_tower' ? 'scale-75 md:scale-[0.55] -mt-[5%] md:-mt-[85%] ml-[25%] md:-ml-[20%] md:-translate-x-[180px]' : ''
        }`}>
          <img
            src={svgPath}
            alt={building.title}
