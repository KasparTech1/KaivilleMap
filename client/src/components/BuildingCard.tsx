    ...
    return (
      <Link to={`/building/${building.id}`} className="block" style={style}>
        <div className={`relative hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 ease-in-out cursor-pointer group ${
          ...
          building.id === 'learning_lodge' ? 'scale-100 -mt-[50%] -ml-[25%] -translate-y-[-20px] md:scale-100 md:mt-[10%] md:-ml-[15%] md:translate-y-0' : 
          building.id === 'community-center' ? 'mt-[60%] -translate-y-[-40px] md:mt-0 md:scale-[0.95] md:translate-y-0' : 
          building.id === 'celebration_station' ? 'scale-[2.0] -mt-[25%] ml-[50%] -translate-y-[-40px] md:scale-[1.2] md:-mt-[10%] md:ml-[40%] md:-translate-x-[220px] md:translate-y-0' : 
          building.id === 'kasp_tower' ? 'scale-100 -mt-[5%] ml-[25%] -translate-y-[-40px] md:scale-[0.63] md:-mt-[85%] md:-ml-[20%] md:-translate-x-[180px] md:translate-y-0' : ''
        }`}>
          <img
            src={svgPath}
            alt={building.title}
